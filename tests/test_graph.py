...
both are professionals. A ring is a connected group of linked people."""
...
def test_two_people_together_in_two_claims_are_a_ring():
    dataset = claims([("Ana", "driver"), ("Ben", "passenger")], [("Ana", "witness"), ("Ben", "driver")])
